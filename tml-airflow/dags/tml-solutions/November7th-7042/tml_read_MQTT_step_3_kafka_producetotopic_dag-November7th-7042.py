...
default_args = {
  ...
  'mqtt_broker' : '3c155878182f4091a77891340e9135bd.s1.eu.hivemq.cloud', # <<<****** Enter MQTT broker i.e. test.mosquitto.org
...
@dag(dag_id="tml_mqtt_step_3_kafka_producetotopic_dag_November7th-7042", default_args=default_args, tags=["tml_mqtt_step_3_kafka_producetotopic_dag_November7th-7042"], schedule=None,catchup=False)
