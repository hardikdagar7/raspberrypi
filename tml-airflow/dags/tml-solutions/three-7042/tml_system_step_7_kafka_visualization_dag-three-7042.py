...
@dag(dag_id="tml_system_step_7_kafka_visualization_dag_three-7042", default_args=default_args, tags=["tml_system_step_7_kafka_visualization_dag_three-7042"], schedule=None,catchup=False)
def startstreaming():    
  def empty():
      pass
dag = startstreaming()
